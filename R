...
local Settings_BTN = Create("TextButton", ButtonsFrame, {
    Text = "∞",
    TextColor3 = Configs_HUB.Cor_Text,
    Size = UDim2.new(0.25, 0, 1, 0),
...
local SettingsFrame = Create("Frame", Menu, {
...
local ThemeDropdown = Create("Frame", SettingsFrame, {
    Size = UDim2.new(0.9, 0, 0, 40),
    Position = UDim2.new(0.05, 0, 0, 40),
    BackgroundColor3 = Configs_HUB.Cor_Hub2
}) Corner(ThemeDropdown) Stroke(ThemeDropdown)

local ThemeLabel = Create("TextLabel", ThemeDropdown, {
    Text = "Theme:",
    TextColor3 = Configs_HUB.Cor_Text,
...
local ThemeOptions = {"Red", "Blue", "Green", "Purple"}
local CurrentTheme = 1

local ThemeValue = Create("TextButton", ThemeDropdown, {
    Text = ThemeOptions[CurrentTheme],
    TextColor3 = Configs_HUB.Cor_Text,
    ...
    Font = Configs_HUB.Text_Font,
    TextSize = 14
}) Corner(ThemeValue) Stroke(ThemeValue)

ThemeValue.MouseButton1Click:Connect(function()
    CurrentTheme = CurrentTheme + 1
    if CurrentTheme > #ThemeOptions then CurrentTheme = 1 end
    ThemeValue.Text = ThemeOptions[CurrentTheme]
end)
